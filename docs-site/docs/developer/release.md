...
安装说明：[vscode-extension/README.md](/clients/vscode-extension#安装)
...
环境要求：JetBrains IDE 2024.2+（需 JCEF）。详见 [jetbrains-extension/README.md](/clients/jetbrains-extension)。
