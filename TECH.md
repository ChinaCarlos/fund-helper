...
入口示意见 [vscode-extension/docs/entry-points.png](./vscode-extension/docs/entry-points.png) 与 [vscode-extension/README.md](./vscode-extension/README.md#入口一览)。
...
| 文档 | 内容 |
|------|------|
| [README.md](./README.md) | 快速入门、API 速查、桌面端下载 |
| [desktop/README.md](./desktop/README.md) | 桌面端功能、开发、打包 |
| [assets/releases/README.md](./assets/releases/README.md) | 桌面安装包与发布说明 |
| [chrome-extension/README.md](./chrome-extension/README.md) | 浏览器插件安装、开发与功能说明 |
| [vscode-extension/README.md](./vscode-extension/README.md) | VS Code 扩展入口、安装与开发 |
...
> 用户文档见 [desktop/README.md](./desktop/README.md)。安装包见 [assets/releases/README.md](./assets/releases/README.md)。
...
> 用户文档见 [vscode-extension/README.md](./vscode-extension/README.md)。入口示意图见 [docs/entry-points.png](./vscode-extension/docs/entry-points.png)。
...
发版脚本 [`publish-vscode.sh`](../publish-vscode.sh)：
...
> 用户文档见 [jetbrains-extension/README.md](./jetbrains-extension/README.md) · [文档中心 · JetBrains 插件](https://chinacarlos.github.io/fund-helper/clients/jetbrains-extension)。
...
发版脚本 [`publish-jetbrains.sh`](../publish-jetbrains.sh)：
...
CI：`.github/workflows/jetbrains-release.yml`（仓库根 `pnpm install` + `pnpm --filter fund-helper-jetbrains-webview run build:webview`；JDK 17 + Gradle；`CI=true` 时拉取 IntelliJ Community 2024.2 编译依赖）。
