...
<!-- fund-helper:version:jetbrains-client -->
...
详见 [文档中心](https://chinacarlos.github.io/fund-helper/) 或 [chrome-extension/README.md](./chrome-extension/README.md)、[vscode-extension/README.md](./vscode-extension/README.md)、[jetbrains-extension/README.md](./jetbrains-extension/README.md) 与 [desktop/README.md](./desktop/README.md)。
...
| **macOS（Universal，M + Intel）** | `Fund-Helper-0.1.2-macos.dmg` | [desktop-v0.1.2 Release](https://github.com/ChinaCarlos/fund-helper/releases/tag/desktop-v0.1.2) |
| **Windows** | `Fund-Helper-0.1.2-windows-setup.exe` | 同上 Release 页 |
<!-- /fund-helper:version:desktop-download -->
...
<!-- fund-helper:version:jetbrains-install -->
...
详见 [jetbrains-extension/README.md](./jetbrains-extension/README.md)；架构见 [TECH.md §20](./TECH.md#20-jetbrains-插件架构)。
