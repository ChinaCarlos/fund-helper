...
import { AccountIcon, FallIcon, RiseIcon } from '@/components/portfolio/AccountIcon';
import { IncomeSparkline } from '@/components/portfolio/IncomeSparkline';
    ...
    >
      ...
      <Row gutter={16}>
        ...
        <Col span={12}>
          ...
          <div>
            <span className="mono" style={incomeAmountStyle(account.today_income)}>
