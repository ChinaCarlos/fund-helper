...
| macOS（Universal，Apple Silicon + Intel） | `Fund-Helper-0.1.0-macos.dmg` | [Release desktop-v0.1.0](https://github.com/ChinaCarlos/fund-helper/releases/tag/desktop-v0.1.0) |
