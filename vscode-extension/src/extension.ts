...
export function activate(context: vscode.ExtensionContext): void {
  try {
    ...
    statusBarItem.command = "fundHelper.showBottomPanel";
    statusBarItem.text = "$(graph) Fund Helper";
    statusBarItem.tooltip = "Fund Helper · 点击打开底部持仓面板";
    statusBarItem.show();

    controller = new FundHelperController(
